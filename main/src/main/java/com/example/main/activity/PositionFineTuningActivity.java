...
/**
 * Created by czy on 2020/8/10 19:32.
 * describe: 地址微调
 */
public class PositionFineTuningActivity extends BaseActivity {
    ...
    protected int setContentView() {
        return R.layout.activity_position_fine_tuning;
    }
                ...
                try {
                    if (null != loc) {
                        ...
                        if (loc.getErrorCode() == 0) {//可在其中解析amapLocation获取相应内容。
                            location = loc;
                            SPUtils.putString(PositionFineTuningActivity.this, DatasKey.LOCATION_INFO, gson.toJson(location));
...
//        mTransAnimator.setInterpolator(new AccelerateDecelerateInterpolator());
    ...
    private void showToastWithErrorInfo(int error) {
        ...
        Toast.makeText(PositionFineTuningActivity.this.getApplicationContext(), tips, Toast.LENGTH_LONG).show();
    }
