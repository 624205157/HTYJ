...
public class MyDialog extends CustomDialog implements View.OnClickListener {
    ...
    public MyDialog(Context context, int contentView, boolean dimEnabled, float width) {
    ...
    protected void onCreateView(WindowManager windowManager) {
        ...
        setDialogWidth((int) (outMetrics.widthPixels * 0.65f));
...
//按钮2
     ...
     * @param clickListener
     */
    public MyDialog setClickListener(CallPhoneListener clickListener) {
     ...
     * @param addView
     */
    public MyDialog setAddView(View addView) {
