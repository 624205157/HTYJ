package com.example.commonlib.okhttp;



import com.example.commonlib.okhttp.https.HttpsUtils;
import com.example.commonlib.okhttp.listener.DisposeDataHandle;
import com.example.commonlib.okhttp.response.CommonJsonCallback;
...
public class CommonOkHttpClient {
    ...
    private static final int TIME_OUT = 3000; //超时参数
